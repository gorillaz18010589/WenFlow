package com.wen.flow.support.custom.banner;
...
import com.wen.flow.support.custom.banner.config.BannerConfig;
import com.wen.flow.support.custom.banner.config.IndicatorConfig;
import com.wen.flow.support.custom.banner.indicator.Indicator;
import com.wen.flow.support.custom.banner.listener.OnBannerListener;
import com.wen.flow.support.custom.banner.listener.OnPageChangeListener;
import com.wen.flow.support.custom.banner.transformer.MZScaleInTransformer;
import com.wen.flow.support.custom.banner.transformer.ScaleInTransformer;
import com.wen.flow.support.custom.banner.util.BannerLifecycleObserver;
import com.wen.flow.support.custom.banner.util.BannerLifecycleObserverAdapter;
import com.wen.flow.support.custom.banner.util.BannerUtils;
import com.wen.flow.support.custom.banner.util.ScrollSpeedManger;
